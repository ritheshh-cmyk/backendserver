...
(function (KeyType) {
    ...
    KeyType[KeyType["DummyKey"] = 2] = "DummyKey";
})(KeyType || (KeyType = {}));
...
function base(keyType, host) {
    var _a, _b, _c, _d;
    var browserAppTokenHost = typeof window !== 'undefined' && keyType === KeyType.DummyKey
        ? window.location.host + "/__space/v0/base"
        : undefined;
    var nodeHost = typeof process !== 'undefined'
        ? (_a = process.env.DETA_BASE_HOST) === null || _a === void 0 ? void 0 : _a.trim()
        : undefined;
    host = (host === null || host === void 0 ? void 0 : host.trim()) ? host : undefined;
    var hostPath = (_d = (_c = (_b = host === null || host === void 0 ? void 0 : host.trim()) !== null && _b !== void 0 ? _b : browserAppTokenHost) !== null && _c !== void 0 ? _c : nodeHost) !== null && _d !== void 0 ? _d : 'database.deta.sh';
    var protocol = (browserAppTokenHost === null || browserAppTokenHost === void 0 ? void 0 : browserAppTokenHost.startsWith('localhost')) ? 'http' : 'https';
    return url.BASE.replace(':protocol', protocol).replace(':host', hostPath);
}
function drive(keyType, host) {
    var _a, _b, _c, _d;
    var browserAppTokenHost = typeof window !== 'undefined' && keyType === KeyType.DummyKey
        ? window.location.host + "/__space/v0/drive"
        : undefined;
    var nodeHost = typeof process !== 'undefined'
        ? (_a = process.env.DETA_DRIVE_HOST) === null || _a === void 0 ? void 0 : _a.trim()
        : undefined;
    host = (host === null || host === void 0 ? void 0 : host.trim()) ? host : undefined;
    var hostPath = (_d = (_c = (_b = host === null || host === void 0 ? void 0 : host.trim()) !== null && _b !== void 0 ? _b : browserAppTokenHost) !== null && _c !== void 0 ? _c : nodeHost) !== null && _d !== void 0 ? _d : 'drive.deta.sh';
    var protocol = (browserAppTokenHost === null || browserAppTokenHost === void 0 ? void 0 : browserAppTokenHost.startsWith('localhost')) ? 'http' : 'https';
...
var Base$1 = (function () {
    ...
    Base.prototype.insert = function (data, key, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, ttl, ttlError, payload, _b, status, response, error, resolvedKey;
            var _c;
...
function Deta(projectKey, authToken) {
    ...
    var apiKey = key || (typeof process !== 'undefined' ? (_a = process.env.DETA_PROJECT_KEY) === null || _a === void 0 ? void 0 : _a.trim() : undefined);
    if (apiKey) {
        return new Deta$1(apiKey, KeyType.ProjectKey, apiKey.split('_')[0]);
    }
    if (typeof window !== 'undefined') {
        return new Deta$1('dummy', KeyType.DummyKey, 'dummy');
    }
