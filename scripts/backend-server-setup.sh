...
# === Backend Server Complete Setup ===
# One-click setup for backend server with Telegram bot integration
...
echo "🚀 === Backend Server Complete Setup ==="
echo ""

# Check if running on backend server (Termux/Android)
if [ -d "/data/data/com.termux" ]; then
    print_info "Detected Termux environment (Android)"
    IS_TERMUX=true
else
...
# 1. Auto-configure Telegram bot
print_info "Step 1: Setting up Telegram bot..."
...
# 4. Create PM2 ecosystem file for backend
...
print_info "Step 7: Creating stop script..."
...
# 8. Create status script
print_info "Step 8: Creating status script..."
...
# 9. Create auto-restart script for Termux:Boot
if [ "$IS_TERMUX" = true ]; then
    print_info "Step 9: Creating Termux:Boot auto-start script..."
...
print_info "Step 10: Creating monitoring script..."
...
echo ""
print_success "=== Backend Server Setup Complete ==="
echo ""
